...
#align(center)[
  ...
  #text(size: 18pt, weight: "semibold", tracking: 0.05em)[#upper()[The]]

  #text(size: 22pt, weight: "semibold", tracking: 0.1em)[#upper()[Maid of Orleans]]

  #v(1fr)

  #text(size: 12pt, style: "italic")[Translated from the German of\ Frederick Henning]

  #v(1fr)

  #text(size: 11pt)[#smallcaps[by]]

  #text(size: 16pt, tracking: 0.025em)[#smallcaps[george p. upton]]\
  #text(size: 9pt, style: "italic")[Translator of "Memories," etc.]

  #v(2fr)

  #image("images/p00a.jpg", scaling: "smooth", height: 7em)

  #v(2fr)

  #text(size: 12pt, tracking: 0.1em)[#smallcaps[chicago]]

  #text(size: 12pt)[#smallcaps[A. C. McClurg & Co.]]


  #text(size: 12pt)[#smallcaps[1904]]
]
...
#align(center)[
  ...
  Typst typesetting by Aaron Purnomo Murniadi

  #text(size: 10pt, style: "italic")[#link("aaronmurniadi@gmail.com")[aaronmurniadi\@gmail.com]]
...
#set page(
  footer: context {
    ...
    let alignment = if calc.odd(page_number) { right } else { left }
...
#set page(
  footer: context {
    let page_number = counter(page).at(here()).first()
    let alignment = if calc.odd(page_number) { right } else { left }
    // Convert the numeric page value to Roman numerals for the display
    align(alignment, numbering("1", page_number))
  },
)
...
As the traveller, descending the valley from Neufchâ-?teau, approaches the
village of Domremy,#footnote[Neufchâteau and Domremy are both in the
  department of Vosges, France. The former is a town with about 4000
  population; the latter, a village, famous as the birthplace of Joan of
  Arc.] he will observe at his right upon an eminence of the nearest range
of hills a stately chestnut-tree, its lower branches hung with wreaths
of flowers, some fresh, some fading. If he does not mind a little
fatigue and climbs to this spot, he will be richly rewarded for his
exertions. The tree in itself is a sufficient compensation for his
...
This tree is the "Fairy Tree."#footnote[One of the witnesses at the
  ...
  other girls, and did as they did. Though she hung garlands on the boughs
  of the 'Fairy Tree,' she liked better to take them into the parish
  church and lay them on the altars of Saint Margaret and Saint
  Catherine."]
...
morning in the year 1424.#footnote[Joan of Arc (Jeanne d'Arc or Darc)
  was born at Domremy, Jan.~6, 1412, and died May 30, 1431. Her father was
  Jacques d'Arc, and her mother Isabelle Romée, illiterate laborers, but
  of good repute. She had three brothers,---Jacques, Pierre, and
...
spring.#footnote[This spring, in the depositions of the witnesses at
  Joan's trial, is always called the "Well of the Thorn."] The fresh green
of the bushes and turf allured her. She threw herself down, and soon was
lulled by the gentle plashing of the water into sweet fancies. For a
long time she failed to observe that she had companions who had come
there to drink,---a doe and fawns, who fearlessly approached and drank
the clear water undisturbed. After they had quenched their thirst, the
fawns stood watching the dreamer with their intelligent little eyes as
if they were awaiting friendly recognition from an old acquaintance. Not
receiving it, they sported frolicsomely around her. Suddenly the
...
Charles the Sixth?"#footnote[Charles the Sixth was born at Paris in
  1368, and died in 1422. He reigned forty-two years, but became deranged
  in 1392, and the Duke of Orleans, his brother, gained the ascendancy. It
  was his Queen, Isabella, who prepared the way for the treaty of Troyes,
  which was to make Henry the Fifth of England King of France on Charles's
  death.]
...
Duke of Bedford, guardian of young Henry the Sixth,#footnote[Henry the
  ...
  Duke of Bedford was his uncle.] did not abandon the field. The infamous
treaty of Troyes gave him the semblance of right."
...
#framed-image("images/p00.jpg", ["Oh, were I only a man!" she sighed.])
...
the castle of Chinon.#footnote[Chinon, a town in the department of
  Indre-et-Loire, France, was a royal residence from the twelfth century
  to the reign of Henry the Fourth. In its great hall Charles the Seventh
  first saw Joan of Arc.] His costume showed that he was of the highest
...
"Eio, eio, eio, no, He cannot be a King Who does not keep his word! Eio,
eio, eio, O, This one here---he is not such, No, no, no, oh, no."
...
Four leagues distant from Cambray#footnote[A town in the department of
  Nord, France, famous for the manufacture of cambrics, which take their
  name from it.] the towers of Beaurevoir Castle rise from forest-crowned
heights. In selecting this spot the builders combined the useful and the
beautiful, for the castle was famous both for its strength and for its
attractive situation. The view from the upper windows and from the
towers repaid the appreciative observer at any season of the year, but
he would have lingered longest in admiration when park and gardens, wood
and meadow, field and grove were decked in the beauty of early spring,
when the thickly clustered villages, east, west, and north, smiled amid
their luxuriant crops, or when on the southern heights the Argonne
forest was clad in its most gorgeous greenery. How much more attractive
the beauties of this spot must have been to a child whose greatest
delight was to be among the flowers of the garden and meadow, the birds
in the parks, and the varied scenery! How closely such a child must have
been attached to such a spot! How strong its temptation to pass all its
time with nature!
...
#framed-image("images/p00b.jpg", ["Dear uncle, see these beautiful violets," she cried.])
...
"Go to the knight, Robert of Baudricourt.#footnote[Robert of Baudricourt
  was the governor of Vaucouleurs.] He will help you."
...
city of Gien#footnote[Gien is in the department of Loiret, and
  thirty-eight miles in a direct line from Orleans. Its principal industry
  is the manufacture of faience.] on the Loire. The news spread like
wildfire that the Maiden who, according to Merlin's prophecy, was to
rescue France, had come, and all hastened to extend her an enthusiastic
welcome.
...
that will remove all doubt as to my mission."#footnote[The doubt which
  was thrown upon the King's legitimacy greatly weighed upon his spirits.
  This doubt Joan removed. Her words to him are thus reported: "On the
  part of my Lord, I tell thee thou art true heir of France and son of the
  King, and he sends me to lead thee to Rheims to the end thou may'st
  receive thy crown and thy coronation if thou wilt."]
...
University of Poitiers.#footnote[Poitiers is the capital of the
  ...
  structure in France.] When they also asked her for a sign, she replied:
"Give me soldiers and you shall have signs enough." They finally
reported that she was trustworthy, and that the King ought to accept her
service. The Dauphin's council promptly decided to raise as many troops
as possible, place the Maiden in command of them, and send her with a
convoy of supplies to Orleans. In these few days popular sentiment had
changed rapidly, cheerful self-sacrifice and enthusiastic eagerness for
action took the place of discouragement and dissension. Knights and
their men at arms offered their services, and wealthy burghers
sacrificed their treasures for the cause of the country. The Dauphin at
last was also in a cheerful frame of mind, for his treasury was filling
up and he could once more take some pleasure in living. He was also in a
position now to be of service to the Maiden. He presented her with a
general's outfit,---a master of horse, two pages, two heralds, and a
chaplain.
...
Bedford#footnote[The Duke of Bedford, an English general and statesman,
  was John Plantagenet, third son of Henry IV, and at this time regent of
  France. He was conspicuous in the prosecution of Joan of Arc.], which
she had dictated to her chaplain. It ran thus:
...
side of Him; on the other, the inscription, "Jesus,
Maria."#footnote[Joan of Arc, testifying at her trial, said: "I had a
  banner of which the field was sprinkled with lilies; the world was
  painted there, with an angel at each side; it was white, of the white
  cloth called bocasine; there was written above, I believe, ''; it was
  fringed with silk. Because the Voices had said to me, 'Take the standard
  in the name of the King of Heaven,' I had this figure of God and of two
  angels done. I did all by their command."] Her demeanor was serious and
dignified, serene confidence shone in her beaming eyes. Her only regrets
were the profanity of the soldiers and La Hire's loud prayer every
morning and evening: "Dear God! do for La Hire as he would do for Thee
if he were the dear God and Thou wert La Hire."
...
of no use to them. At this juncture the Bastard of
Orleans,#footnote[Count Jean Dunois, called the "Bastard of Orleans,"
  was born in 1402, and died in 1468. He was the natural son of Louis,
  Duke of Orleans, and Mariette d'Enghien, and at this time was in command
  at Orleans.] commander of the city, came in a barge to meet them. By his
advice they went two leagues farther up the river and made a halt near
Castle Chécy, where they found a French garrison. Count Dunois agreed to
send a fleet for the transportation of the supplies, but at three in the
afternoon it had not come. The sky was overcast, thunder growled in the
distance, and the waves of the Loire were lashed by fierce winds. The
courage of the soldiers began to waver.
...
field, the worm in the dust,---all these are wonders of creation which
the multitude scarcely notices, but which are marvellous to the
observant thinker."
...
= V --- The Coronation and the Capture
...
there.#footnote[Tradition says that Clovis and all his successors for
  nine centuries were anointed with this oil.] They returned, escorted by
a grand procession headed by the Abbot of San Remy, who walked under a
canopy, carrying the phial.
...
#framed-image("images/p01.jpg", [The last act in the ceremony was Charles's coronation.])
...
with that miserable Loup---but, holy Ursula! are you ill? Your hand is
as cold as ice."
